#  python3 ../myexperiments/falcon_twist/falcon_twist_45.py
import os
import sys

# 1.mesh_names
mesh_names = ['falconstatue']
...
# 3.pr
pr_list = ['0.3']
deform_scale_list = ['0.5'] # '3','5.5' #useless

#旋转
rotate_ratio_list = [ '0.25']
...
# 
deform_styles = ['stretch_twist_top'] #['twist_right_rotate_ratio',‘twist_top_rotate_ratio’]
